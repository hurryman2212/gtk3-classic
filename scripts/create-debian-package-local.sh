...
# Is this running on Debian?
if [ ! "$DISTRO" == "Debian" ]; then
    echo "Wrong distro! This script only works on Debian."
    exit 1
fi
...
dpkg-buildpackage -rfakeroot -b -uc -us # https://gist.github.com/luigifab/0fce786cdb93b5687069a82f490ea95e#file-gtk-3-24-48-deb-sh
